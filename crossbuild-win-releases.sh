...
if [ $i686_ok ]; then
    ...
    # execute cmake
    cd $build_i686_dir
    $i686_cmake ../.. -DCMAKE_INSTALL_PREFIX=../$install_i686_dir -DWIN32_STATIC_BUILD=TRUE -DWIN32_LIBS="`$i686_pkg_config sfml --libs`"
...
if [ $x86_64_ok ]; then
    ...
    # execute cmake
    cd $build_x86_64_dir
    $x86_64_cmake ../.. -DCMAKE_INSTALL_PREFIX=../$install_x86_64_dir -DWIN32_STATIC_BUILD=TRUE -DWIN32_LIBS="`$i686_pkg_config sfml --libs`"
    make -j8 install
    cd ..
